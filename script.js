...
//RENDER THE SECOND(CU) BUSINESS' 3D MODEL OR LOGO - AND SET THE OBJECTS ATTRIBUTES
 function renderPlacesCU(placesCU) {
  let sceneCU = document.querySelector('a-scene');
    placesCU.forEach((placeCU) => {
      ...
      modelCU.setAttribute('scale', '1 1 1');
           //allows to rotate
      modelCU.setAttribute('animation', 'property: rotation; to: 0 360 0; loop:true; dur: 4000; easing: linear');
 ...
 for (var i = 0; i < els.length; i++) {
  modelCU.setAttribute('position','0 0 0')
  //  modelCU.setAttribute('scale','50 50 50')
   console.log(els[i]);
 }
